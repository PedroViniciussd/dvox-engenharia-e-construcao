...
const pageData = {
  "slug": "gerenciamento-de-obras-sp",
  "title": "Gerenciamento de Obras SP | D/vox Construções",
  "description": "Gerenciamento de obras em São Paulo com acompanhamento técnico, planejamento, cronograma, controle de execução, fornecedores e qualidade.",
  "kicker": "Gerenciamento de obras SP",
  "h1": "Gerenciamento de obras em São Paulo para construir com mais segurança",
  "intro": "A D/vox Construções oferece gerenciamento de obras para clientes que precisam de organização, acompanhamento, controle de etapas e mais tranquilidade durante a execução.",
  "image": "https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1800&q=85",
  "keywords": [
    "gerenciamento de obras SP",
    "gestão de obras São Paulo",
    "acompanhamento de obra",
    "empreitada total SP"
  ],
  "sections": [
    {
      "title": "Controle de etapas e prazos",
      "text": "O gerenciamento de obras ajuda a organizar cronograma, fornecedores, execução, materiais e prioridades para reduzir atrasos e retrabalhos."
    },
    {
      "title": "Acompanhamento técnico",
      "text": "Com acompanhamento próximo, a obra fica mais alinhada ao projeto e às expectativas do cliente, com mais controle sobre a qualidade."
    },
    {
      "title": "Mais tranquilidade para o cliente",
      "text": "A D/vox centraliza a comunicação e o acompanhamento da obra, tornando o processo mais claro, organizado e seguro."
    }
  ],
  "faqs": [
    {
      "question": "O que inclui gerenciamento de obras?",
      "answer": "Pode incluir planejamento, cronograma, acompanhamento da execução, controle de etapas, fornecedores e validação da qualidade."
    },
    {
      "question": "Gerenciamento ajuda a evitar atrasos?",
      "answer": "Sim. Uma obra bem gerenciada tem mais previsibilidade e menor risco de retrabalho."
    },
    {
      "question": "A D/vox faz empreitada total?",
      "answer": "Sim. A D/vox também trabalha com soluções completas e empreitada total conforme o escopo do projeto."
    }
  ]
};
