...
const pageData = {
  "slug": "construcao-civil-sp",
  "title": "Construção Civil em São Paulo | D/vox Construções",
  "description": "Construção civil em São Paulo para obras residenciais, comerciais e prediais com planejamento, execução profissional e gerenciamento de obra.",
  "kicker": "Construção civil SP",
  "h1": "Construção civil em São Paulo com execução profissional e acompanhamento técnico",
  "intro": "A D/vox Construções atua em obras residenciais, comerciais, corporativas e prediais, oferecendo planejamento, execução, acompanhamento e soluções completas para tirar projetos do papel com segurança.",
  "image": "https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1800&q=85",
  "keywords": [
    "construção civil SP",
    "construtora em São Paulo",
    "obra residencial São Paulo",
    "obra comercial SP",
    "obra predial",
    "construção civil grande São Paulo",
    "construção civil no interior paulista"

  ],
  "sections": [
    {
      "title": "Execução completa para obras",
      "text": "A construção civil exige planejamento, equipe qualificada, controle de etapas e acompanhamento constante. A D/vox atua com foco em qualidade, prazo e acabamento em obras de diferentes portes."
    },
    {
      "title": "Atendimento residencial, comercial e predial",
      "text": "Executamos projetos para residências, empresas, comércios, ambientes corporativos e obras prediais, com soluções adaptadas ao escopo e à necessidade de cada cliente."
    },
    {
      "title": "Do planejamento à entrega",
      "text": "A D/vox pode atuar desde a organização inicial até a entrega final, centralizando a execução e facilitando a rotina do cliente durante a obra."
    }
  ],
  "faqs": [
    {
      "question": "A D/vox executa obras completas?",
      "answer": "Sim. A empresa atua com construção civil, reformas, gerenciamento de obras e soluções completas conforme o escopo do projeto."
    },
    {
      "question": "Vocês atendem obras comerciais?",
      "answer": "Sim. A D/vox atende obras residenciais, comerciais, corporativas e prediais em São Paulo e região."
    },
    {
      "question": "Atendem fora da capital?",
      "answer": "Sim. O atendimento cobre São Paulo capital, Grande São Paulo e interior paulista."
    }
  ]
};
