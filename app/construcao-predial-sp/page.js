...
const pageData = {
  "slug": "construcao-predial-sp",
  "title": "Construção Predial SP | D/vox Construções",
  "description": "Construção predial em São Paulo, restauração de fachadas, reformas e soluções para obras prediais com planejamento e acompanhamento técnico.",
  "kicker": "Construção predial SP",
  "h1": "Construção predial e restauração de fachadas em São Paulo",
  "intro": "A D/vox Construções atende obras prediais, reformas, fachadas e soluções técnicas para edifícios, condomínios e empreendimentos em São Paulo.",
  "image": "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1800&q=85",
  "keywords": [
    "construção predial SP",
    "restauração de fachadas São Paulo",
    "obra predial SP",
    "reforma predial"
  ],
  "sections": [
    {
      "title": "Soluções para obras prediais",
      "text": "Obras prediais exigem planejamento técnico, segurança e controle de execução. A D/vox atua com reformas, construção e apoio em demandas prediais."
    },
    {
      "title": "Restauração e valorização de fachadas",
      "text": "A revitalização de fachadas contribui para a segurança, estética e valorização do imóvel, além de melhorar a imagem do empreendimento."
    },
    {
      "title": "Atendimento para condomínios e empresas",
      "text": "Atendemos edifícios, condomínios, empresas e obras prediais em São Paulo, Grande São Paulo e interior paulista."
    }
  ],
  "faqs": [
    {
      "question": "A D/vox trabalha com fachada?",
      "answer": "Sim. A empresa atua com restauração, revitalização e soluções para fachadas."
    },
    {
      "question": "Vocês atendem condomínios?",
      "answer": "Sim. A D/vox pode atender condomínios, edifícios, empresas e empreendimentos."
    },
    {
      "question": "Construção predial exige gerenciamento?",
      "answer": "Sim. O gerenciamento ajuda no controle de etapas, prazos, fornecedores e qualidade da execução."
    }
  ]
};
