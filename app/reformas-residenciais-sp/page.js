...
const pageData = {
  "slug": "reformas-residenciais-sp",
  "title": "Reformas Residenciais SP | D/vox Construções",
  "description": "Reformas residenciais em São Paulo para casas e apartamentos com acabamento premium, planejamento, execução e gerenciamento profissional.",
  "kicker": "Reformas residenciais SP",
  "h1": "Reformas residenciais em São Paulo com acabamento premium",
  "intro": "A D/vox Construções transforma casas, apartamentos e ambientes residenciais com reformas planejadas, acabamento moderno e execução organizada.",
  ...
  "keywords": [
    ...
    "reforma de casa SP",
    "reforma premium São Paulo"
  ],
  "sections": [
    {
      "title": "Transformação de ambientes residenciais",
      "text": "Reformar uma residência exige cuidado com estética, funcionalidade, prazo e acabamento. A D/vox atua para valorizar cada ambiente com soluções modernas e bem executadas."
    },
    {
      "title": "Acabamento premium",
      "text": "Trabalhamos com foco em detalhes, integração de ambientes, revestimentos, iluminação, pintura, hidráulica, elétrica e soluções sob medida para cada projeto."
    },
    {
      "title": "Planejamento para evitar dor de cabeça",
      "text": "Com acompanhamento e organização das etapas, a reforma se torna mais previsível, segura e alinhada ao resultado esperado."
    }
  ],
  "faqs": [
    {
      "question": "A D/vox faz reforma de apartamento?",
      "answer": "Sim. A empresa atende reformas de apartamentos, casas e ambientes residenciais."
    },
    {
      "question": "Vocês ajudam no planejamento?",
      "answer": "Sim. A D/vox pode auxiliar na organização das etapas, definição do escopo e acompanhamento da execução."
    },
    {
      "question": "A reforma pode ter acabamento premium?",
      "answer": "Sim. O foco da D/vox é entregar reformas com acabamento moderno, qualidade e valorização do imóvel."
    }
  ]
};
