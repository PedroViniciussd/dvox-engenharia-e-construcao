...
const pageData = {
  "slug": "restauracao-de-fachadas-sp",
  "title": "Restauração de Fachadas SP | D/vox Construções",
  "description": "Restauração de fachadas em São Paulo para edifícios, empresas, condomínios e imóveis comerciais com revitalização, pintura e acabamento.",
  "kicker": "Restauração de fachadas SP",
  "h1": "Restauração de fachadas em São Paulo para valorizar e proteger imóveis",
  "intro": "A D/vox Construções atua com restauração, pintura, revitalização e soluções para fachadas residenciais, comerciais, prediais e corporativas em São Paulo.",
  "image": "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1800&q=85",
  "keywords": [
    "restauração de fachadas SP",
    "revitalização de fachada São Paulo",
    "pintura de fachada SP",
    "reforma de fachada"
  ],
  "sections": [
    {
      "title": "Valorização e proteção do imóvel",
      "text": "A fachada é uma das partes mais importantes da apresentação de um imóvel. A restauração adequada melhora a estética, preserva a estrutura e valoriza o patrimônio."
    },
    {
      "title": "Soluções para prédios, empresas e comércios",
      "text": "Atendemos fachadas residenciais, comerciais, corporativas e prediais com planejamento, organização e acabamento profissional."
    },
    {
      "title": "Execução com cuidado técnico",
      "text": "Cada fachada exige avaliação, preparação de superfície, escolha correta de materiais e execução organizada para um resultado duradouro."
    }
  ],
  "faqs": [
    {
      "question": "A D/vox restaura fachada de prédio?",
      "answer": "Sim. A empresa atende fachadas prediais, comerciais, residenciais e corporativas."
    },
    {
      "question": "Restauração de fachada valoriza o imóvel?",
      "answer": "Sim. Além de melhorar a aparência, a restauração ajuda a proteger e valorizar o patrimônio."
    },
    {
      "question": "Vocês atendem São Paulo e região?",
