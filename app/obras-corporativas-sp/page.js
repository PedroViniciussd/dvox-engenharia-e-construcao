...
const pageData = {
  "slug": "obras-corporativas-sp",
  "title": "Obras Corporativas SP | D/vox Construções",
  "description": "Obras corporativas em São Paulo para empresas, escritórios, áreas administrativas e ambientes profissionais com gerenciamento e execução completa.",
  "kicker": "Obras corporativas SP",
  "h1": "Obras corporativas em São Paulo com gestão, prazo e acabamento",
  "intro": "A D/vox Construções atende empresas e ambientes corporativos com execução de obras, reformas, adequações e gerenciamento profissional.",
  "image": "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1800&q=85",
  "keywords": [
    "obras corporativas SP",
    "obra para empresa São Paulo",
    "reforma corporativa SP",
    "construção para empresas"
  ],
  "sections": [
    {
      "title": "Projetos para empresas",
      "text": "Ambientes corporativos exigem planejamento, organização e execução técnica. A D/vox atua em escritórios, áreas administrativas, recepções e espaços empresariais."
    },
    {
      "title": "Gerenciamento e execução",
      "text": "A obra corporativa precisa de previsibilidade. Por isso, atuamos com acompanhamento, controle de etapas e foco em entrega profissional."
    },
    {
      "title": "Espaços que comunicam valor",
      "text": "A construção ou reforma de ambientes corporativos melhora a percepção da empresa e contribui para um espaço mais funcional e moderno."
    }
  ],
  "faqs": [
    {
      "question": "A D/vox atende empresas?",
      "answer": "Sim. A D/vox executa obras e reformas para empresas, escritórios e ambientes corporativos."
    },
    {
      "question": "Vocês fazem adequação de espaços?",
      "answer": "Sim. A empresa atua com reformas, adequações, construção e gerenciamento de ambientes profissionais."
    },
    {
      "question": "Atendem obras corporativas de maior porte?",
      "answer": "Sim. O atendimento pode ser adaptado para obras pequenas, médias e grandes."
    }
  ]
};
