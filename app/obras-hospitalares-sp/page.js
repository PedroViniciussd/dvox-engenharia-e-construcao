...
const pageData = {
  slug: 'obras-hospitalares-sp',

  title:
    'Obras Hospitalares em São Paulo | D/vox Construções',

  description:
    'Empresa especializada em obras hospitalares em São Paulo. Reformas hospitalares, adequações técnicas, clínicas médicas, consultórios, laboratórios e ambientes de saúde.',

  kicker: 'Obras Hospitalares SP',

  h1: 'Obras hospitalares em São Paulo com planejamento, segurança e execução especializada',

  intro:
    'A D/vox Construções executa obras hospitalares, reformas em clínicas, consultórios, laboratórios e ambientes de saúde com foco em qualidade, organização e respeito às exigências técnicas de cada projeto.',
  ...
  keywords: [
    ...
    'reformas hospitalares São Paulo',
    'empresa de obras hospitalares',
    'reforma de clínica médica',
    'reforma de consultório médico',
    'construção de clínica médica',
    'adequação hospitalar',
    'obras em hospitais',
    'reforma de laboratório',
    'engenharia hospitalar SP',
  ],

  sections: [
    {
      title: 'Execução de obras hospitalares',
      text:
        'Hospitais, clínicas e unidades de saúde exigem planejamento rigoroso, organização e controle de execução. A D/vox atua em obras hospitalares com foco em qualidade construtiva, segurança e eficiência operacional.',
    },

    {
      title: 'Reformas de clínicas e consultórios',
      text:
        'Realizamos reformas e adequações de clínicas médicas, odontológicas, consultórios e centros de atendimento, criando ambientes modernos, funcionais e preparados para receber pacientes e profissionais.',
    },

    {
      title: 'Adequações técnicas e ampliações',
      text:
        'Executamos ampliações, modernizações e adequações técnicas para ambientes hospitalares e laboratoriais, contribuindo para espaços mais organizados, eficientes e preparados para novas demandas.',
    },
  ],

  faqs: [
    {
      question: 'A D/vox realiza obras hospitalares?',
      answer:
        'Sim. A D/vox executa obras hospitalares, reformas, adequações técnicas e ampliações em hospitais, clínicas e ambientes de saúde.',
    },

    {
      question: 'Vocês atendem clínicas e consultórios?',
      answer:
        'Sim. Atendemos clínicas médicas, odontológicas, laboratórios, consultórios e demais ambientes ligados à área da saúde.',
    },

    {
      question: 'Atendem São Paulo e região?',
      answer:
        'Sim. Atuamos em São Paulo capital, Grande São Paulo e diversas cidades do interior paulista.',
    },
  ],
};
